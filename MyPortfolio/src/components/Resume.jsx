          ...
          <div className="projects" data-aos="fade-left">
            ...
            <div className="projectinfo">
              <div className="project-card" data-aos="flip-left">
                ...
                <a href="https://aryan-portfolio-pi.vercel.app/" target="_blank" rel="noopener noreferrer">
                  View Project
                </a>
              </div>
            ...
            <div className="certifications">
              ...
              <div className="certi">
                <ul className="set1" data-aos="fade-right">
                  <li>Solved 120+ LeetCode problems and 50+ questions on GeeksForGeeks and TakeUForward</li>
                  <li>Contributed to open-source repositories and tech communities.</li>
                  <li>Participated in national-level hackathons and coding contests.</li>
                </ul>
              </div>
            </div>
          </div>
